...
### 上海台风季（到港月 Jun–Oct，航次等权，剔除 ETA）

年 = **到港年**（Latest Vessel Schedule 的年/月）。华东台风季约 95% 热带气旋落在 6–10 月；峰值 7–9 月。港口冲击在 SHA，故主口径用到港月，不用 HAM ATD 月。

一页纸：`deliverables/HAM-SHA_typhoon_season_leadtime.pdf`  
生成：`deliverables/source/build_ham_sha_typhoon_season_onepager.py`

| 到港年 | n | 最短 | 最长 | 季内均 | 中位数 | 80% | 季外均 | 峰值 Jul–Sep 均 |
|---|---|---|---|---|---|---|---|---|
| 2023 | 22 | 46 | 74 | **53.8** | 52 | 57 | 45.9 | 55.3 |
| 2024 | 31 | 44 | 67 | **54.6** | 55 | 57 | 57.4 | 54.7 |
| 2025 | 33 | 45 | 83 | **51.7** | 50 | 55 | 54.4 | 49.9 |
| 2026（Jun–Aug 到港） | 15 | 51 | 71 | **59.3** | 58 | **65** | 50.1 | 62.0 |

2026 到港月：Jun 53.8（n=5）→ Jul 56.0（n=4）→ **Aug 66.0**（n=6，59–71）。季内最短 51 > 2025 季内中位数 50。  
2026 年 9 月到港仍为 ETA（截止 2026-09-07），不当恢复。Jul–Aug ATD 行本身也是 ETA，未进上表。  
公开背景（非本公司 B/L）：2026-07-10~13 台风巴威洋山清港；2026-08-08~11 台风白海豚，42 艘国际航行船舶变更计划。
